...
function sendNew() {
    ...
    function run() {
        if (document.getElementById("txt").value.includes(":/database") && (check2.checked == false) && (check3.checked == true) && (value1.selected == true)) {
        ...
        } else if (document.getElementById("txt").value.includes(":/question yourself") && (check2.checked == true) && (check3.checked == false) && (value3.selected == true)) {
            var y = document.getElementById("onestagetwo");
            y.style.display = "block";
            ipcolor.style.backgroundColor = "#8BE78B";//green
            document.getElementById("node").innerHTML = "N1";
        } else if (document.getElementById("txt").value.includes(":/password crack") && (check2.checked == true) && (check3.checked == false) && (value1.selected == true)) {
        ...
        } else if (document.getElementById("txt").value.includes(":/breach firewall") && (check2.checked == false) && (check3.checked == true) && (value2.selected == true)) {
            var xy = document.getElementById("onestagefour");
            xy.style.display = "block";
            ipcolor.style.backgroundColor = "#0097DF";//blue
            document.getElementById("node").innerHTML = "N3";
        } else if (document.getElementById("txt").value.includes(":/storm event") && (check2.checked == false) && (check3.checked == true) && (value3.selected == true)) {
            ...
            ipcolor.style.backgroundColor = "#8BE78B";//green
            document.getElementById("node").innerHTML = "N3";
        } else if (document.getElementById("txt").value.includes(":/aliens") && (check2.checked == true) && (check3.checked == false) && (value3.selected == true) && (result1.style.display === "block") && (result2.style.display === "block")) {
